...
$(document).ready(function () {
  ...
  function addAnswer(element) {
    ...
    if (numMaxAnswers > numAnswers) {
      ...
      alertDiv(
        "Error numero de respuestas",
        "No se puede crear más de " + numMaxAnswers + " respuestas",
        errorContainer
      );
    }
  }
  ...
  var questionCounter =
    document.getElementById("question_answer").childElementCount;
  function addQuestion() {
    ...
    if (numMaxQuestions > numQuestions) {
      ...
      let btnDeleteQuestionList = document.querySelectorAll(
      ...
      let errorContainer = document.getElementById("error");
      alertDiv(
        "Error numero de preguntas",
        "No se puede crear mas de " + numMaxQuestions + " preguntas",
        errorContainer
      );
    }
  }
